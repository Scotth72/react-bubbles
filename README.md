...
- [ ] Explain what a token is used for.
      Tokens allow the user to sign into a page successfully.

- [ ] What steps can you take in your web apps to keep your data secure?
    A Private route is set up to be sure the user has the ablity to access the data.

- [ ] Describe how web servers work.
    Servers contain the website data that is accessed with a IP address.
